...
from train_regression3 import model_1_X_train , model_1_X_test, model_1_y_train, model_1_y_test,reg,model_1_X, model_1_y

# loading the model
with open('reg_model_3.pkl', 'rb') as f:
    model = pickle.load(f)
...
plt.title('Actual values of Sepal Length and petal width predicted regression line')
plt.show()
plt.show()
