...
model.fit(X_train[:, 3], y_train) # fitting for input petal width
print("\nActual values",y_test)

# predictions
y_pred_p = model.predict(X_test[:, 3])
...
# plotting
plot_decision_regions(X_test[:, 3].reshape(-1, 1), y_test, clf=model, legend=2)
